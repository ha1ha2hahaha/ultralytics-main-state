...
class RandomPerspective:
    ...
    def __call__(self, labels):
        ...
        new_instances = Instances(bboxes, segments, keypoints, states, bbox_format='xyxy', normalized=False)
        # Clip
...
class Format:
    ...
    def __call__(self, labels):
        ...
        if self.return_keypoint:
            ...
            labels['states'] = torch.from_numpy(instances.states)
            # 406行 ，在—__call__函数要先显式初始化，否则在并行运算的时候，会报错
