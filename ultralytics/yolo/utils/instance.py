...
class Instances:
    ...
    def __init__(self, bboxes, segments=None, keypoints=None, states=None, bbox_format='xywh', normalized=True) -> None:
        """
        Args:
    ...
    def __getitem__(self, index) -> 'Instances':
        ...
        states = self.states[index] if self.states is not None else None
    ...
    def concatenate(cls, instances_list: List['Instances'], axis=0) -> 'Instances':
        ...
        cat_states = np.concatenate([b.states for b in instances_list], axis=axis) if use_keypoint else None
        cat_keypoints = np.concatenate([b.keypoints for b in instances_list], axis=axis) if use_keypoint else None
        return cls(cat_boxes, cat_segments, cat_keypoints, cat_states, bbox_format, normalized)
