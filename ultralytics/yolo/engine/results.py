...
class Results(SimpleClass):
    ...
    def __init__(self, orig_img, path, names, boxes=None, masks=None, probs=None, keypoints=None, states=None) -> None:
    ...
    def plot(
        ...
        state = self.states
        n = {0: "Stand", 1: "Sit", 2: "Squat", 3: "Walk", 4: "Lie", 5: "Fall", 6: "Bend", 7: "Kneel"}
        ...
        if pred_boxes and show_boxes:
            for d in reversed(pred_boxes):
                ...
                last_state = state.tolist()[-1]
                name = f'{n[int(last_state[-1])]}'
                label = f'{name}  {str(last_state[int(last_state[-1])])[:5]}'
